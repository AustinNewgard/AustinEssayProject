...
String Track1 = "Hollaback Girl";
String Track2 = "September";
String Track3 = "HYMM OF THE USSR";
String Track4 = "Electric Zoo";
String Track5 = "Rocket Man";
String Track6 = "NUGGET IN A BUSCUIT";
